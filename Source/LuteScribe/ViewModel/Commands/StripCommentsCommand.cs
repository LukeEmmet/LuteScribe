...
namespace LuteScribe.ViewModel.Commands
{
    ...
    public class StripCommentsCommand : ICommand
    {
        ...
        public StripCommentsCommand(MainWindowViewModel viewModel)
        {
        ...
        public void Execute(object parameter)
        {
            ...
            {
                //remove the comments only                
                foreach (var chord in (
                        from chord in stave.Chords
                        where chord.IsComment
                        select chord).ToArray())
                {
