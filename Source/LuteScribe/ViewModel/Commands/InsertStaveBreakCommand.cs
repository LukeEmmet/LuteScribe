...
namespace LuteScribe.ViewModel.Commands
{
    ...
    public class InsertStaveBreakCommand : ICommand
    {

        // Member variables
        private readonly MainWindowViewModel _viewModel;

        private bool _noUndo = false;

        public bool NoUndo { set { _noUndo = value; } }

        public InsertStaveBreakCommand(MainWindowViewModel viewModel)
        {
